            ...
            <div class="container">
                ...
                <div class="row content">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
                        ...
                        <ul class="fs-5">
                            <li><i class="ri-check-double-line fs-4 "></i>
                            ...
                            <li><i class="ri-check-double-line fs-4"></i>Gestion:Confiez-nous la gestions de vos
                                applications et restez concentré sur votre coeur de métier. </li>
                            <li><i class="ri-check-double-line fs-4"></i>Rendements: Maitrisez vos pics d'activité et
                                renforcez votre croissance. </li>
                        </ul>
                        <p class="fst-italic">

                        <h3 class="fs-4">Faites le choix de l'excellence numérique. Faites confiance à Teckisat pour
                            réaliser vos
                ...
                <div class="row counters">
                    ...
                    <div class="col-lg-3 col-6 text-center">
                        <span data-purecounter-start="0" data-purecounter-end="521" data-purecounter-duration="1"
                            class="purecounter"></span>
                        <p class="fs-4">Projets</p>
                    </div>

                    <div class="col-lg-3 col-6 text-center">
                        <span data-purecounter-start="0" data-purecounter-end="24" data-purecounter-duration="1"
                            class="purecounter"></span>
                        <p class="fs-4">Disponible</p>
                    </div>

                    <div class="col-lg-3 col-6 text-center">
                        <span data-purecounter-start="0" data-purecounter-end="10" data-purecounter-duration="1"
                            class="purecounter"></span>
                        <p class="fs-4">Travailleurs</p>
                    </div>
        ...
        <section id="cta" class="cta">
            <div class="container">
                ...
                <div class="text-center" data-aos="zoom-in">
                    <h3 class="fs-3">Découvrir nos réalisations</h3>
                    <p class="fs-4"> Explorez notre portfolio varié, offrant une gamme diversifiée de sites web et
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="section-title" data-aos="fade-right">
                            <h2>Services</h2>
                            <p class="fs-3">Société spécialisée dans le développement informatique et la création de
                                logiciels
        ...
        <section id="portfolio" class="portfolio">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-left">
                    ...
                    <p class="fs-3">Notre équipe chez Teckisat est fière de présenter nos réalisations les plus récentes,
                        témoignant de
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <ul id="portfolio-flters">
                            ...
                            <li data-filter=".filter-app">Applications mobiles</li>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('img/portfolio/web4.jpg') }}" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Site web 2</h4>
                                <p>Site web</p>
                                <div class="portfolio-links">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="section-title" data-aos="fade-right">
                            <h2>Témoignages</h2>
                            <p class="fs-3">Découvrez ce que nos clients ont à dire sur leur expérience avec Teckisat et
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <p>
                                            ...
                                            d'hébergement. Leur infrastructure robuste et leur support technique de qualité
                                            ont été essentiels pour assurer la disponibilité et la sécurité de nos données
                                            sensibles. Nous recommandons vivement Teckisat pour leurs solutions
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <p>
                                            ...
                                            technique et leur approche méthodique. Leur équipe talentueuse a su comprendre
                                            nos besoins spécifiques et livrer une solution sur mesure qui a dépassé nos
                                            attentes. Teckisat est définitivement notre choix pour tout projet futur de
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="section-title" data-aos="fade-right">
                            ...
                            <p class="fs-3">Découvrez l'équipe passionnée et talentueuse qui se cache derrière Teckisat.
                                Notre équipe
                ...
                <div class="row">
                    <div class="col-lg-4" data-aos="fade-right">
                        <div class="section-title">
                            <h2>Contact</h2>
                            <p class="fs-3">Contactez-nous dès aujourd'hui pour discuter de vos besoins. Notre équipe
                    ...
                    <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="info mt-4">
                            ...
                            <h4 class="fs-3">Adresse:</h4>
                            <p class="fs-4">Lot 1594 Tankpe, Abomey-Calavi, BENIN</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 mt-4">
                                <div class="info">
                                    <i class="bi bi-envelope"></i>
                                    <h4 class="fs-3">Email:</h4>
                                    <p class="fs-4">contact@teckisat.com</p>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="info w-100 mt-4">
                                    <i class="bi bi-phone"></i>
                                    <h4 class="fs-3">Téléphone:</h4>
                                    <p class="fs-4">+ 229 67 529 720</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form mt-4">
                            ...
                            <div class="text-center fs-4"><button type="submit">Envoyer</button></div>
                        </form>
                    </div>
                </div>
